...
Route::group(['namespace' => 'api\v1', 'prefix' => 'v1', 'middleware' => 'return-json'], function () {
    ...
    Route::group(['prefix' => 'bid', 'middleware' => 'auth:api'], function () {
        Route::post('/load-board/accept', [LoadBoardController::class, 'acceptBidByCustomer']);
    ...
    Route::post('/store', [DriverMangerController::class, 'store']);
        ...
        Route::middleware(['auth:api'])->group(function () {
          //  Route::get('/your-url', function () {
                ...
                Route::get('/my-drivers', [DriverMangerController::class, 'index']);
                Route::get('/available-drivers', [DriverMangerController::class, 'index']);
                Route::get('/my-truck', [TruckController::class, 'truck']);
                Route::get('/available-truck', [TruckController::class, 'truck']);
