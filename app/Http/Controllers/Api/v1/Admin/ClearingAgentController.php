    ...
    public function search(Request $request)
{
    ...
    public function show($agentId) {
        ...
        if (!$agent) {
            ...
            return $this->error('', 'Clearing Agent not found', 422);
    ...
    public function destroy($agentId)
    {
        ...
        if (!$agent) {
                return $this->error('', 'Clearing Agent not found', 404);
            }
            ...
            return $this->success([], 'Clearing Agent and user deleted successfully');

        }
        } catch (\Exception $e) {
            return $this->error('', 'Unable to delete Clearing Agent and user', 500);
        }
    }
