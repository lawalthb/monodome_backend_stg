...
class TruckController extends Controller
{
  ...
  //     return TruckResource::collection($drivers);
  // }
  ...
  public function show($DriverId)
  {
    ...
    return new TruckResource($Driver);
  }
  ...
  public function update(Request $request, $id)
  {
    try {
      ...
      return $this->success(new TruckResource($user->Driver), 'Driver updated successfully');
    } catch (\Exception $e) {
      DB::rollBack();
  ...
  public function setStatus(Request $request, $driverID)
  {
    ...
    return $this->success(['driver' => new TruckResource($driver)], 'Driver status updated successfully');
  }
}
