...
class LoadPackageResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'deliver_to' => ($this->deliver_to == "office") ? new AgentResource($this->toOffice) :  null,            // "from_office_id" => $this->from_office_id,load
            'deliver_from' => ($this->deliver_from == "office") ? new AgentResource($this->fromOffice) :  null,            // "from_office_id" => $this->from_office_id,load
