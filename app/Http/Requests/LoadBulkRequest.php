...
class LoadBulkRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sender_street_no' => 'required|string|max:20',
            'sender_lga' => 'required|string|max:50',
            'sender_apartment' => 'required|string|max:50',
            'sender_state_id' => 'required|integer|max:50',
           ...
           // 'from_office_id' => 'required|integer',
            ...
            'receiver_lga' => 'nullable|string|max:50',
            'receiver_apartment' => 'nullable|string|max:50',
            'receiver_street_no' => 'nullable|string|max:50',
            'receiver_state_id' => 'nullable|string|max:50',
            'receiver_email' => 'nullable|email|max:50',
           // 'receiver_number' => 'required|string|max:50',
