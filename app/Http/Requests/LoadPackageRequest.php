    ...
    public function rules(): array
    {
        return [
           ...
           'receiver_email' => 'nullable|email|max:50',
            ...
            'weight' => 'required_if:is_document,Yes|numeric',
            'width' => 'required_if:is_document,Yes|numeric',
            'length' => 'required_if:is_document,Yes|numeric',
            'height' => 'required_if:is_document,Yes|numeric',
