    ...
    public function rules(): array
    {
        return [
           ...
           'receiver_email' => 'nullable|email|max:50',
            ...
            'weight' => 'required_if:is_document,No|numeric',
            'width' => 'required_if:is_document,No|numeric',
            'length' => 'required_if:is_document,No|numeric',
            'height' => 'required_if:is_document,No|numeric',
